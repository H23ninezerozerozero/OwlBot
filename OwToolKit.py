...
version = '3.0'
def updateCheck():
    r = requests.get('https://pastebin.com/f5QJdEFw')
    if version in r.text:
        return
    else:
      os.system('cls')
      print(f"Update available Join: https://discord.gg/hkSphbTZVE")
      print(f'Press [Enter] key to Exit.')
      while True:
...
#snipper
def Spinner():
    ctypes.windll.kernel32.SetConsoleTitleW(f'[OwKit] Made by Monster.#6666 | Loading')
    os.system('cls')
    l = ['|', '/', '-', '\\']
...
def nuketoken():
  os.system('cls')
  ctypes.windll.kernel32.SetConsoleTitleW(f'[OwKit] Made by Monster.#6666 | Nuke Token')
  print(f'''\u001b[32m
   ██████╗ ██╗    ██╗██╗  ██╗██╗████████╗
  ██╔═══██╗██║    ██║██║ ██╔╝██║╚══██╔══╝
  ██║   ██║██║ █╗ ██║█████╔╝ ██║   ██║
  ...
  ╚██████╔╝╚███╔███╔╝██║  ██╗██║   ██║
   ╚═════╝  ╚══╝╚══╝ ╚═╝  ╚═╝╚═╝   ╚═╝
         {Fore.CYAN}{Style.BRIGHT} ●  Discord: Monster.#6666                            {Fore.RESET}
...
def unverifytoken():
    os.system('cls')
    ctypes.windll.kernel32.SetConsoleTitleW(f'[OwKit] Made by Monster.#6666 | Unverify Token')
    print(f'''\u001b[32m
   ██████╗ ██╗    ██╗██╗  ██╗██╗████████╗
  ██╔═══██╗██║    ██║██║ ██╔╝██║╚══██╔══╝
  ██║   ██║██║ █╗ ██║█████╔╝ ██║   ██║   
...
def bantoken():
    os.system('cls')
    ctypes.windll.kernel32.SetConsoleTitleW(f'[OwKit] Made by Monster.#6666 | Ban Token')
    print(f'''\u001b[32m
   ██████╗ ██╗    ██╗██╗  ██╗██╗████████╗
  ██╔═══██╗██║    ██║██║ ██╔╝██║╚══██╔══╝
  ██║   ██║██║ █╗ ██║█████╔╝ ██║   ██║   
...
def tokenfromuserid():
    os.system('cls')
    ctypes.windll.kernel32.SetConsoleTitleW(f'[OwKit] Made by Monster.#6666 | Half Token From User ID')
    print(f'''\u001b[32m
   ██████╗ ██╗    ██╗██╗  ██╗██╗████████╗
  ██╔═══██╗██║    ██║██║ ██╔╝██║╚══██╔══╝
  ██║   ██║██║ █╗ ██║█████╔╝ ██║   ██║   
...
def tokenvalidator():
    os.system('cls')
    ctypes.windll.kernel32.SetConsoleTitleW(f'[OwKit] Made by Monster.#6666 | Token Validator')
    print(f'''\u001b[32m
   ██████╗ ██╗    ██╗██╗  ██╗██╗████████╗
  ██╔═══██╗██║    ██║██║ ██╔╝██║╚══██╔══╝
  ██║   ██║██║ █╗ ██║█████╔╝ ██║   ██║   
...
def hypesquad():
    os.system('cls')
    ctypes.windll.kernel32.SetConsoleTitleW(f'[OwKit] Made by Monster.#6666 | Hypesquad Changer')
    print(f'''\u001b[32m
   ██████╗ ██╗    ██╗██╗  ██╗██╗████████╗
  ██╔═══██╗██║    ██║██║ ██╔╝██║╚══██╔══╝
  ██║   ██║██║ █╗ ██║█████╔╝ ██║   ██║   
...
def nitrogen():
    os.system('cls')
    ctypes.windll.kernel32.SetConsoleTitleW(f'[OwKit] Made by Monster.#6666 | Nitro Generator')
    print(f'''\u001b[32m
   ██████╗ ██╗    ██╗██╗  ██╗██╗████████╗
  ██╔═══██╗██║    ██║██║ ██╔╝██║╚══██╔══╝
  ██║   ██║██║ █╗ ██║█████╔╝ ██║   ██║   
...
def tokengen():
  os.system('cls')
  ctypes.windll.kernel32.SetConsoleTitleW(f'[OwKit] Made by Monster.#6666 | Token Generator')
  print(f'''\u001b[32m
   ██████╗ ██╗    ██╗██╗  ██╗██╗████████╗
  ██╔═══██╗██║    ██║██║ ██╔╝██║╚══██╔══╝
  ██║   ██║██║ █╗ ██║█████╔╝ ██║   ██║   
...
def trolltoken():
    os.system('cls')
    ctypes.windll.kernel32.SetConsoleTitleW(f'[OwKit] Made by Monster.#6666 | Troll Token')
    print(f'''\u001b[32m
   ██████╗ ██╗    ██╗██╗  ██╗██╗████████╗
  ██╔═══██╗██║    ██║██║ ██╔╝██║╚══██╔══╝
  ██║   ██║██║ █╗ ██║█████╔╝ ██║   ██║   
...
def tokeninfo():
    os.system('cls')
    ctypes.windll.kernel32.SetConsoleTitleW(f'[OwKit] Made by Monster.#6666 | Token Info')
    print(f'''\u001b[32m
   ██████╗ ██╗    ██╗██╗  ██╗██╗████████╗
  ██╔═══██╗██║    ██║██║ ██╔╝██║╚══██╔══╝
  ██║   ██║██║ █╗ ██║█████╔╝ ██║   ██║   
...
def informations():
    os.system('cls')
    ctypes.windll.kernel32.SetConsoleTitleW(f'[OwKit] Made by Monster.#6666 | Informations & contact')
    print(f'''\u001b[32m
   ██████╗ ██╗    ██╗██╗  ██╗██╗████████╗
  ██╔═══██╗██║    ██║██║ ██╔╝██║╚══██╔══╝
  ██║   ██║██║ █╗ ██║█████╔╝ ██║   ██║   
...
def tokenfetcher():
    os.system('cls')
    ctypes.windll.kernel32.SetConsoleTitleW(f'[OwKit] Made by Monster.#6666 | Get token from email:password')
    print(f'''\u001b[32m
   ██████╗ ██╗    ██╗██╗  ██╗██╗████████╗
  ██╔═══██╗██║    ██║██║ ██╔╝██║╚══██╔══╝
  ██║   ██║██║ █╗ ██║█████╔╝ ██║   ██║   
...
def checkwebhook():
  os.system('cls')
  ctypes.windll.kernel32.SetConsoleTitleW(f'[OwKit] Made by Monster.#6666 | Check Webhook')
  print(f'''\u001b[32m
   ██████╗ ██╗    ██╗██╗  ██╗██╗████████╗
  ██╔═══██╗██║    ██║██║ ██╔╝██║╚══██╔══╝
  ██║   ██║██║ █╗ ██║█████╔╝ ██║   ██║   
...
def spamwebhook():
  os.system('cls')
  ctypes.windll.kernel32.SetConsoleTitleW(f'[OwKit] Made by Monster.#6666 | Spam Webhook')
  print(f'''\u001b[32m
   ██████╗ ██╗    ██╗██╗  ██╗██╗████████╗
  ██╔═══██╗██║    ██║██║ ██╔╝██║╚══██╔══╝
  ██║   ██║██║ █╗ ██║█████╔╝ ██║   ██║   
...
def tokenlogin():
  os.system('cls')
  ctypes.windll.kernel32.SetConsoleTitleW(f'[OwKit] Made by Monster.#6666 | Token Informations')
  print(f'''\u001b[32m
   ██████╗ ██╗    ██╗██╗  ██╗██╗████████╗
  ██╔═══██╗██║    ██║██║ ██╔╝██║╚══██╔══╝
  ██║   ██║██║ █╗ ██║█████╔╝ ██║   ██║   
...
def getBanner():
    os.system('cls')
    ctypes.windll.kernel32.SetConsoleTitleW(f'[OwKit] Made by Monster.#6666 | Main Menu')
